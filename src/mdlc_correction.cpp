...
double get_DLC_dipolar(int kcut,double *fx, double *fy, double *fz, double *tx, double *ty, double *tz){
  ...
  ReSjp= (double *) pmalloc(sizeof(double)*n_local_particles);
  ReSjm= (double *) pmalloc(sizeof(double)*n_local_particles);
  ImSjp= (double *) pmalloc(sizeof(double)*n_local_particles);
  ImSjm= (double *) pmalloc(sizeof(double)*n_local_particles);
  ReGrad_Mup = (double *) pmalloc(sizeof(double)*n_local_particles);
  ImGrad_Mup = (double *) pmalloc(sizeof(double)*n_local_particles);
  ReGrad_Mum = (double *) pmalloc(sizeof(double)*n_local_particles);
  ImGrad_Mum = (double *) pmalloc(sizeof(double)*n_local_particles);
...
void    add_mdlc_force_corrections(){
  ...
  dip_DLC_f_x = (double *) pmalloc(sizeof(double)*n_total_particles);
  dip_DLC_f_y = (double *) pmalloc(sizeof(double)*n_total_particles);
  dip_DLC_f_z = (double *) pmalloc(sizeof(double)*n_total_particles);
	 
  dip_DLC_t_x = (double *) pmalloc(sizeof(double)*n_total_particles);
  dip_DLC_t_y = (double *) pmalloc(sizeof(double)*n_total_particles);
  dip_DLC_t_z = (double *) pmalloc(sizeof(double)*n_total_particles);
