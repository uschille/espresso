...
int get_lipid_orients(IntList* l_orient) {
  ...
  height_grid = (double*) pmalloc((mode_grid_3d[xdir])*sizeof(double)*mode_grid_3d[ydir]);
...
*/
  if ( mode_grid_changed ) {
    ...
    height_grid = (double*) pmalloc((mode_grid_3d[xdir])*sizeof(double)*mode_grid_3d[ydir]);
    result      = (fftw_complex*) pmalloc((mode_grid_3d[ydir]/2+1)*(mode_grid_3d[xdir])*sizeof(fftw_complex)); 
...
int bilayer_density_profile ( IntList *beadids, double hrange , DoubleList *density_profile, int usegrid) {
  ...
  tmp_height_grid = (double*) pmalloc((mode_grid_3d[xdir])*sizeof(double)*mode_grid_3d[ydir]);
  /* Calculate physical size of grid mesh */
  grid_size[xdir] = box_l[xdir]/(double)mode_grid_3d[xdir];
  grid_size[ydir] = box_l[ydir]/(double)mode_grid_3d[ydir];
...
int calc_fluctuations ( double* height_grid, int switch_fluc ) {
  ...
  height_grid_up = (double*) pmalloc((mode_grid_3d[xdir])*sizeof(double)*mode_grid_3d[ydir]);
  height_grid_down = (double*) pmalloc((mode_grid_3d[xdir])*sizeof(double)*mode_grid_3d[ydir]);
  grid_parts_up = (int*) pmalloc((mode_grid_3d[xdir])*sizeof(int)*mode_grid_3d[ydir]);
  grid_parts_down = (int*) pmalloc((mode_grid_3d[xdir])*sizeof(int)*mode_grid_3d[ydir]);
  grid_parts = (int*) pmalloc((mode_grid_3d[xdir])*sizeof(int)*mode_grid_3d[ydir]);
